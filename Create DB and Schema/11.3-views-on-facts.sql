...
select * from consumption_sch.vw_monthly_revenue_kpis where year = 2020;
...
select * from consumption_sch.vw_daily_revenue_kpis where year = 2024 and month = 7;
...
select * from consumption_sch.vw_day_revenue_kpis where year = 2024 and month = 7;

create or replace view SANDBOX.CONSUMPTION_SCH.VW_MONTHLY_REVENUE_BY_RESTAURANT(
	YEAR,
	MONTH,
	DELIVERY_STATUS,
	RESTAURANT_NAME,
